          ...
          slivers: [
            SliverAppBar(
              ...
              flexibleSpace: const FlexibleSpaceBar(
                title: Text(AppStringSignIn.signInPageTitle),
              ),
            ),
            SliverList(
                                    ...
                                    OutlinedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.pushNamed(context,
                                            Routes.signInUserNameScreen);
                                      },
                                      child: Text(
                                        AppStringSignIn
                                            .signInWithUsernameButtonText,
                        ...
                        RichText(
                          text: TextSpan(
                            children: [
                              ...
                              TextSpan(
                                text: AppStringSignIn.createAccountButtonText,
                                style: TextStyle(
                                  color: ColorManager.lightBlue1,
