...
import '../../../presentation/screens/see_all_category/all_categories_screen.dart';
...
class NavigationBarProvider with ChangeNotifier {
  final List<BottomNavigationBarItem> _bottomNavigationBarItems = [
    customNavigationBar(
        ...
        labelText: AppStringNavigationBar.explore,
    ...
    customNavigationBar(
        ...
        activeColor: ColorManager.lightBlue1,
        iconSize: AppSize.s28,
        labelText: AppStringNavigationBar.myLearning,
        icon: CupertinoIcons.play_circle,
        activeIcon: CupertinoIcons.play_circle),
    customNavigationBar(
        color: ColorManager.lightGrey,
        activeColor: ColorManager.lightBlue1,
        iconSize: AppSize.s28,
        labelText: AppStringNavigationBar.account,
  ...
  void isCategoriesHomeScreen(bool value) {
    _bottomNavigationBarWidget.removeAt(0);
    _bottomNavigationBarWidget.insert(
      0,
      (value == true) ? const AllCategoriesScreen() : const HomePage(),
    );
  }
}
