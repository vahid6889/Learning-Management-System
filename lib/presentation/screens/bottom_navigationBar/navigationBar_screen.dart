...
class NavigationBarScreen extends StatelessWidget {
  const NavigationBarScreen({Key? key, this.categoriesHomeScreen})
      : super(key: key);

  final bool? categoriesHomeScreen;
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<NavigationBarProvider>(
      ...
      if (categoriesHomeScreen == true) {
        navigationBarItems.isCategoriesHomeScreen(true);
      } else {
        navigationBarItems.isCategoriesHomeScreen(false);
      }
      return Scaffold(
